...
import "./login.css"
import { useAuth } from "../contexts/AuthContext" // Adicione esta linha ou verifique se já existe
    ...
    <div className="login-container">
      ...
      <div className="login-content">
        <div className="coat-of-arms">
          <img src="/images/coat-of-arms.png" alt="Coat of Arms" className="coat-image" />
        </div>

        <div className="login-card">
          <div className="login-header">
            <h1>SARC</h1>
            <p>Sistema de Alocação de Recursos e Controle</p>
          </div>
